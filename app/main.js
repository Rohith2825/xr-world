...
// import displayMobileControls from "./Experience/MobileControls.js";
...
function onMouseClick(event) {
  ...
  const intersects = raycaster.intersectObjects(experience.scene.children);
  ...
  if (intersects.length > 0) {
      ...
      // Optionally: log or handle the intersected object
